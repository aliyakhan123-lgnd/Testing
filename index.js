...
/* ==================== 🔥 ARIF BABU BOT LAUNCHER 🔥 ==================== */

console.log("\n" + "=".repeat(60));
console.log("🚀 ARIF BABU BOT - LAUNCHER SYSTEM 🚀");
...
app.use((req, res, next) => {
    ...
    res.setHeader('X-Powered-By', 'ARIF BABU BOT');
    next();
});
...
// Display banner
console.log("\n" + "⭐".repeat(30));
console.log("    ARIF BABU BOT - LAUNCHER v2.0");
...
// Start the bot
setTimeout(() => {
    startBot("🚀 Starting ARIF BABU BOT...");
}, 1000);
